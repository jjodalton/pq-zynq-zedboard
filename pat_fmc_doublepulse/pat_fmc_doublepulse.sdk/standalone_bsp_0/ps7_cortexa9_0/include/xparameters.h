...
/* Definitions for peripheral CLK_PAT */
#define XPAR_CLK_PAT_BASEADDR 0x43C00000
#define XPAR_CLK_PAT_HIGHADDR 0x43C0FFFF
...
/* Definitions for peripheral AXI_GPIO_ABPINS */
#define XPAR_AXI_GPIO_ABPINS_BASEADDR 0x41240000
#define XPAR_AXI_GPIO_ABPINS_HIGHADDR 0x4124FFFF
#define XPAR_AXI_GPIO_ABPINS_DEVICE_ID 1
#define XPAR_AXI_GPIO_ABPINS_INTERRUPT_PRESENT 1
#define XPAR_AXI_GPIO_ABPINS_IS_DUAL 1


/* Definitions for peripheral AXI_GPIO_CLOCK */
#define XPAR_AXI_GPIO_CLOCK_BASEADDR 0x41250000
#define XPAR_AXI_GPIO_CLOCK_HIGHADDR 0x4125FFFF
#define XPAR_AXI_GPIO_CLOCK_DEVICE_ID 2
#define XPAR_AXI_GPIO_CLOCK_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_CLOCK_IS_DUAL 1


/* Definitions for peripheral AXI_GPIO_DAC */
#define XPAR_AXI_GPIO_DAC_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_DAC_HIGHADDR 0x4120FFFF
#define XPAR_AXI_GPIO_DAC_DEVICE_ID 3
#define XPAR_AXI_GPIO_DAC_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_DAC_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_MODES */
#define XPAR_AXI_GPIO_MODES_BASEADDR 0x41230000
#define XPAR_AXI_GPIO_MODES_HIGHADDR 0x4123FFFF
#define XPAR_AXI_GPIO_MODES_DEVICE_ID 4
#define XPAR_AXI_GPIO_MODES_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_MODES_IS_DUAL 0


/* Definitions for peripheral AXI_GPIO_PWM */
#define XPAR_AXI_GPIO_PWM_BASEADDR 0x41210000
#define XPAR_AXI_GPIO_PWM_HIGHADDR 0x4121FFFF
#define XPAR_AXI_GPIO_PWM_DEVICE_ID 5
#define XPAR_AXI_GPIO_PWM_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_PWM_IS_DUAL 1
...
#define XPAR_FABRIC_AXI_GPIO_ABPINS_IP2INTC_IRPT_INTR 61
