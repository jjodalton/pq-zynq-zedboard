...
module design_1_wrapper
 ...
 pwm_generator_doublepulse pulser_low(.clk(pwm_clk), .reset_n(clk_pat_locked), .start_1(gpio_pwm_1_tri_o[19:10]), .end_1(gpio_pwm_1_tri_o[9:0]),
  .start_2(gpio_pwm_2_tri_o[19:10]), .end_2(gpio_pwm_2_tri_o[9:0]), .pwm_low(pwm_low)) ;
  
 pwm_generator_doublepulse pulser_high(.clk(pwm_clk), .reset_n(clk_pat_locked), .start_1(gpio_pwm_1_tri_o[19:10]), .end_1(gpio_pwm_1_tri_o[9:0]),
   .start_2(gpio_pwm_2_tri_o[19:10]), .end_2(gpio_pwm_2_tri_o[9:0]), .pwm_low(pwm_high)) ;
