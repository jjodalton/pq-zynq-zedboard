...
proc create_root_design { parentCell } {
  ...
  set apins [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 apins ]
  set bpins [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 bpins ]
  ...
  set_property -dict [ list CONFIG.C_ALL_INPUTS {0} CONFIG.C_ALL_INPUTS_2 {0} CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_DOUT_DEFAULT {0x000000cc} CONFIG.C_GPIO2_WIDTH {8} CONFIG.C_GPIO_WIDTH {8} CONFIG.C_INTERRUPT_PRESENT {1} CONFIG.C_IS_DUAL {1} CONFIG.GPIO2_BOARD_INTERFACE {Custom} CONFIG.GPIO_BOARD_INTERFACE {Custom} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_abpins
  ...
  set_property -dict [ list CONFIG.C_ALL_OUTPUTS {0} CONFIG.C_DOUT_DEFAULT {0x00000400} CONFIG.C_GPIO_WIDTH {11} CONFIG.C_IS_DUAL {0} CONFIG.C_TRI_DEFAULT {0x00000400} CONFIG.GPIO_BOARD_INTERFACE {Custom} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_dac
  ...
  set_property -dict [ list CONFIG.C_ALL_INPUTS {0} CONFIG.C_ALL_OUTPUTS {1} CONFIG.GPIO_BOARD_INTERFACE {Custom} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_modes
  ...
  connect_bd_intf_net -intf_net axi_gpio_abpins_GPIO [get_bd_intf_ports apins] [get_bd_intf_pins axi_gpio_abpins/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_abpins_GPIO2 [get_bd_intf_ports bpins] [get_bd_intf_pins axi_gpio_abpins/GPIO2]
